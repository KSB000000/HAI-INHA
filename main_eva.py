...
def parse_args():
    ...
    parser.add_argument('--input_size', type=int, default=448, help='Input size of model')
    ...
    parser.add_argument('--metrics_file', type=str, default="val_eva.json", help='Metric file name')
...
def main(args):
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(np.zeros(len(targets)), targets)):
        ...
        for model_name in model_names:
            ...
            train_dataset.dataset.transform = get_train_transform(args.input_size)
            val_dataset.dataset.transform = get_val_transform(args.input_size)
